...
//         리사이클러뷰
    ...
    private void startRecording() {
        ...
        //녹음 시작
        mediaRecorder.start();
        String a = Integer.toString(mediaRecorder.getMaxAmplitude());
        Log.d("sd", a);
    }
    ...
    private void playAudio(File file) {
        ...
        playIcon.setImageDrawable(getResources().getDrawable(R.drawable.ic_play, null));
        isPlaying = true;
